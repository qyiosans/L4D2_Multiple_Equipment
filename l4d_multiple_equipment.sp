...
public void OnPluginStart()
{
	...
	AmmoLockSlot1 = CreateConVar("l4d_ammo_lock_slot1", "0", "[LOCK THIS SLOT IF USING LIMITED PISTOL AMMO], 0=Disable Lock Slot1 Ammo, 1=Enable Lock Slot1 Ammo", FCVAR_NOTIFY);
